...
export default function Ace5(){
    ...
    return(
        ...
        <div>
         ...
         <div className='a2'>
                    <div className='b1'>
                        <img className='filtro2' src="/assets/images/acessorio-5.png" alt="" />
                    </div>



                    <div className='b2'>
                        <h3 className='titulo'>DRENO ANTI-TURBILHÃO 1.1/2" ㅤㅤㅤㅤㅤLATÃO</h3>
                ...
                <div className='a3'>
                    ...
                    <img className='setaesquerda' src="/assets/images/setaesquerda.png" alt="" />
                        ...
                        <div className='c1'>
                            <img className='imagizi' src="/assets/images/acessorio-2.png" alt="" />
                        ...
                        <div className='c2'>
                            <img className='imagizi' src="/assets/images/acessorio-3.png" alt="" />
                        ...
                        <div className='c4'>
                            <img className='imagizi' src="/assets/images/acessorio-1.png" alt="" />
