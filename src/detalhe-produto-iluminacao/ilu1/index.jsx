...
export default function Ilu1(){
    ...
    return(
        ...
        <div>
         ...
         <div className='a2'>
                    <div className='b1'>
                        <img className='filtro2' src="/assets/images/ilu-1.png" alt="" />
                    </div>
                ...
                <div className='a3'>
                    ...
                    <img className='setaesquerda' src="/assets/images/setaesquerda.png" alt="" />
                        ...
                        <div className='c1'>
                            <img className='imagizi' src="/assets/images/ilu-2.png" alt="" />
                        ...
                        <div className='c2'>
                            <img className='imagizi' src="/assets/images/ilu-3.png" alt="" />
                        ...
                        <div className='c3'>
                            <img className='imagizi' src="/assets/images/ilu-4.png" alt="" />
                        ...
                        <div className='c4'>
                            <img className='imagizi' src="/assets/images/ilu-5.png" alt="" />
