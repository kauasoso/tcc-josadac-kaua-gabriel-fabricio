...
export default function Pis1(){
    ...
    return(
        ...
        <div className='a2'>
            <div className='b1'>
                <img className='filtro2' src="/assets/image/piso-1.png" alt="" />
            </div>



            <div className='b2'>
                <h3 className='titulo'>REVESTIMENTO PARA PISCINA AZUL VISCAYA</h3>

                <h5 className='descricao'>
O revestimento para piscina Azul Viscaya 30,3x30,30 em jatobá é uma opção elegante e versátil para quem deseja dar um toque especial ao seu espaço de lazer. Com um tom de azul claro e brilhante, esse revestimento é inspirado em pedras naturais, o que confere um aspecto sofisticado e natural à piscina.</h5>
        ...
        <div className='a3'>
            ...
            <div className='b3'>
                ...
                <div className='c1'>
                    ...
                    <h4 className='ds'>REVESTIMENTO PISCINA NORONHA</h4>
