...
<div className='tudo'>
    ...
    <select name="" id="filtro">
        ...
        <section className='divis'>
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/acessorio-1.png" alt="" />
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/acessorio-2.png" alt="" />
                <div className='line'></div>     
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/acessorio-3.png" alt="" />
                <div className='line'></div>  
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/acessorio-4.png" alt="" />
                <div className='line'></div>     
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/acessorio-5.png" alt="" />
                <div className='line'></div>    
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/acessorio-6.png" alt="" />
                <div className='line'></div> 
