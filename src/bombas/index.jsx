...
<div className='tudo'>
    ...
    <select name="" id="filtro">
        ...
        <section className='divis'>
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/bomba-1.png" alt="" />
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/bomba-2.png" alt="" />
                <div className='line'></div>    
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/bomba-3.png" alt="" />
                <div className='line'></div> 
