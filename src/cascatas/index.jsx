...
<div className='tudo'>
    ...
    <select name="" id="filtro">
        ...
        <section className='divis'>
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/casca-1.png" alt="" />
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/casca-2.png" alt="" />
                <div className='line'></div>     
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/casca-3.png" alt="" />
                <div className='line'></div>  
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/casca-4.png" alt="" />
                <div className='line'></div>     
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/casca-5.png" alt="" />
                <div className='line'></div>    
            ...
            <div className='abc'>
            <img className='imagi' src="/assets/images/casca-6.png" alt="" />
                <div className='line'></div> 
